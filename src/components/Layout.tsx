...
const Logo = ({ className, neutralColor }: { className?: string; neutralColor?: string }) => (
  <img src="/src/assets/logo.svg" alt="UNIQUE DC MOTOR BRAKES" className={className} />
);
    ...
    <nav className="fixed top-0 left-0 right-0 z-[60] bg-white border-b border-gray-100 shadow-md">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          <div className="flex items-center px-4 sm:px-8 border-r border-gray-100">
            <Link to="/" className="flex items-center gap-2 group">
              <Logo className="h-8 md:h-10 w-auto transition-transform group-hover:scale-105 duration-300" neutralColor="fill-slate-950" />
            </Link>
          </div>
        ...
        {isOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute right-0 top-0 bottom-0 w-[80%] max-w-sm bg-white shadow-2xl flex flex-col pt-24 px-6 pb-12"
            >
              ...
              <div className="mt-auto pt-12">
                <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-6">Connect with us</div>
    ...
    <footer className="bg-[#05070a] text-slate-400 pt-16 pb-8 relative overflow-hidden border-t border-white/5 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-y-12 gap-x-8 lg:gap-8 mb-12">
          ...
          {/* Location Block with Map - Responsive */}
          <div className="col-span-2 lg:col-span-8">
            ...
            >
              <div className="w-full aspect-[4/3] sm:aspect-[4/3] lg:aspect-square bg-white/5 border border-white/10 rounded-lg overflow-hidden relative shadow-lg shadow-brand-red/10">
                <iframe 
                  ...
                  title="Unique DC Motor Brake Location on Google Maps"
                  className="opacity-80 group-hover:opacity-100 transition-opacity duration-500"
                />
                <div className="absolute inset-0 bg-gradient-to-tr from-brand-red/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                <div className="absolute inset-0 bg-brand-red/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none">
                  <div className="bg-gradient-to-r from-brand-red/90 to-red-600/90 backdrop-blur-md px-3 sm:px-4 py-2 rounded-lg border border-brand-red/30 text-white text-[9px] sm:text-[10px] font-bold uppercase tracking-widest shadow-lg">
                    Click to View on Google Maps
                  </div>
                </div>
              </div>
              <p className="mt-4 text-[11px] sm:text-xs font-bold uppercase tracking-widest text-slate-500 flex items-center gap-2 group-hover:text-brand-red transition-colors leading-relaxed">
                <MapPin size={14} className="text-brand-red shrink-0" />
                <span>Regd. office & Mfg. Unit gudli, near power house, Udaipur, Rajasthan 313024</span>
              </p>
            </a>
          </div>
        </div>
